                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header"> 
                            <?php echo(isset($precificacao) ? '<i class="ik ik-calendar ik-1x"></i> &nbsp; Data da última alteração:&nbsp;'.formata_data_banco_com_hora ($precificacao-> precificacao_data_alteracao) : ''); ?> 
                        </div>
                        <div class="card-body">
